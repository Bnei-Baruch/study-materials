              ...
              >
                ...
                <div className="p-1.5 sm:p-2.5 flex items-start gap-1 sm:gap-2">
                  <div className={`flex-1 ${isRTL ? 'pr-1 sm:pr-2' : 'pl-1 sm:pl-2'}`}>
                    <h4 className={`${colors.text} text-[13px] sm:text-[14px] font-bold break-words`}>
                      {partTitle}
                    </h4>
                    {part.description && (
                      <p className="text-gray-600 leading-snug mt-0.5 text-[11px] sm:text-[12px] line-clamp-2">
                        {part.description}
                      </p>
                    )}
                  </div>
                  ...
                  <div className={`space-y-1 sm:space-y-1.5 ${isRTL ? 'pr-1.5 sm:pr-2.5 pl-1.5 sm:pl-2.5' : 'px-1.5 sm:px-2.5'} pb-1.5 sm:pb-2.5`}>
                    {allLinks.map((link, linkIdx) => (
                      ...
                      >
                        ...
                        >
                          {link.text}
                          {link.page && <span className="text-gray-500 text-[10px] sm:text-[11px]"> (p. {link.page})</span>}
                        </a>
      ...
      {showShareMenu && (
        ...
        >
          <div
            ...
            dir={isRTL ? 'rtl' : 'ltr'}
          >
            <h4 className="text-gray-900 font-bold mb-2 sm:mb-3 text-[15px] sm:text-[16px]">
              {t.shareLesson}
            </h4>
            <div className="space-y-2">
              ...
              >
                ...
                <span className="text-[13px] sm:text-[14px]">WhatsApp</span>
              </button>
              <button
                onClick={() => {
                  const text = showShareMenu === 'lesson' 
              ...
              >
                ...
                <span className="text-[13px] sm:text-[14px]">Telegram</span>
              </button>
            </div>
            <button
              onClick={() => setShowShareMenu(null)}
