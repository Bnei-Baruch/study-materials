...
const TITLES = {
  ...
  es: 'Materiales de estudio',
  de: 'Studienmaterialien',
  it: 'Materiali di studio',
  fr: 'Matériaux d\'étude',
    ...
    <nav className="bg-white shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {isRTL ? (
            <>
              {/* RTL Layout: Language selector on left, Logo+Title on right */}
              <div>
                <select
                  value={language}
                  onChange={(e) => handleLanguageChange(e.target.value)}
                  className="bg-white rounded-lg shadow-sm px-3 py-1.5 text-gray-700 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                >
