        ...
        <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
          ...
          <a href="#" className="flex items-center gap-0 hover:opacity-80 transition-opacity">
            ...
            <div className="flex flex-col gap-0.5">
              <h1 className="text-blue-900 leading-none" style={{ fontSize: '28px' }}>
                {SITE_NAME[language as keyof typeof SITE_NAME]}
              </h1>
              <p className="text-blue-800 leading-none" style={{ fontSize: '16px' }}>
          ...
          <div className="relative">
            <select
              ...
              className={`appearance-none bg-white border-2 border-gray-200 rounded-lg px-4 py-2 ${isRTL ? 'pr-10 pl-3' : 'pl-10 pr-3'} text-gray-700 hover:border-blue-300 focus:border-blue-500 focus:outline-none cursor-pointer transition-colors`}
              style={{ fontSize: '14px' }}
            >
            ...
            <ChevronDown className={`w-4 h-4 text-gray-500 absolute ${isRTL ? 'right-3' : 'left-3'} top-1/2 -translate-y-1/2 pointer-events-none`} />
          </div>
        </div>
      </div>
    </header>
