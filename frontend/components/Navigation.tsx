...
const SITE_SUBTITLE = {
  he: 'קהילת לומדי קבלה',
  en: 'Kabbalah Learning Community',
  ru: 'Сообщество изучающих Каббалу',
  es: 'Comunidad de Aprendizaje de Cabalá',
  de: 'Kabbala-Lerngemeinschaft',
