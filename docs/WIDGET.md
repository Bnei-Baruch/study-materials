...
StudyMaterialsWidget.load(null, 'he', {
  position: 'inline',
  apiUrl: 'http://your-domain.com:8080',
  limit: 10,
  width: '320px',
...
```javascript
javascript:(function(){const s=document.createElement('script');s.src='http://localhost:3000/widget/widget.js';s.setAttribute('data-auto-inject','true');s.setAttribute('data-language','he');s.setAttribute('data-limit','10');s.setAttribute('data-api-url','http://your-domain.com:8080');document.head.appendChild(s);})();
```
...
| `data-api-url` | URL | `http://your-domain.com:8080` | Backend API endpoint |
...
```javascript
// Test in console
fetch('http://your-domain.com:8080/api/events/YOUR_EVENT_ID')
  .then(r => r.json())
  .then(console.log)
```
...
```bash
curl -I http://your-domain.com:8080/api/events/YOUR_EVENT_ID
